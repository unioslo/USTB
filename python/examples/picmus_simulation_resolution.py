"""PICMUS Simulation Resolution Distortion.

Python equivalent of examples/picmus/simulation_resolution_distortion.m.
75 plane-wave sequence simulated with Field II.
"""
...
def main():
    ...
    fig, ax = b_data.plot(title="PICMUS Simulation Resolution")
    save_image(fig, "picmus_sim_resolution.png")
    return b_data
