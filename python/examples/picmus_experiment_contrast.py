"""PICMUS Experiment Contrast Speckle.

Python equivalent of examples/picmus/experiment_contrast_speckle.m.
"""
...
def main():
    ...
    fig, ax = b_data.plot(title="PICMUS Experiment Contrast")
    save_image(fig, "picmus_exp_contrast.png")
    return b_data
