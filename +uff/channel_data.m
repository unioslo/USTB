classdef channel_data < uff
    ...
    %
    %   CHANNEL_DATA holds the raw RF or IQ data as acquired from an
    %   ultrasound scanner or generated by a simulator. The data array has
    %   dimensions [time x channel x wave x frame].
    %
    %   When modulation_frequency is zero the data is RF (real-valued).
    %   When nonzero the data is IQ (complex baseband).
    %
    %   Properties:
    %       sampling_frequency      sampling frequency [Hz]
    %       initial_time            time of the first sample [s]
    %       sound_speed             reference sound speed [m/s]
    %       modulation_frequency    modulation frequency [Hz] (0 = RF data)
    %       sequence                array of UFF.WAVE objects
    %       probe                   UFF.PROBE object
    %       data                    data [time x channel x wave x frame]
    ...
    %       N_waves                 number of transmit events
    %       N_frames                number of frames
    %       lambda                  wavelength [m]
    %
    %   Example:
    %       ch = uff.channel_data();
    %       ch.sampling_frequency = 40e6;
    %       ch.sound_speed = 1540;
    %
