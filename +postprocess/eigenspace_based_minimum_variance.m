...
%   $Last updated: 2017/05/02$
    ...
    methods (Access = public)
        function h=eigenspace_based_minimum_variance()
            h.name='Eigenspace Based Minimum Variance MATLAB';
            ...
            for e = 1:E
                ...
                for k = 1:N
                    ...
                    if (sum(abs(rf_data(k,:))>eps) == 0)
                        ...
                        %Split into signal space and noise space
                        [V,D] = eig(R_sub,'vector');
                        eig_values = D;
                        ...
                        for j = idx(1):idx(end)-L_new+1
                            z(k,e) = z(k,e) + w_esmv'*rf_data(k,j:L_new+j-1)';
                        end
                        %Average output
